...
export function VisionMissionHero() {
  return (
    <section className="relative isolate grid min-h-[420px] place-items-center overflow-hidden px-5 py-20 text-center text-white lg:min-h-[480px]">
      ...
      <ScrollReveal>
        <p className="text-xs font-bold uppercase tracking-[0.28em] text-amber-300">Our institutional direction</p>
        <h1 className="mt-5 text-5xl font-black tracking-tight sm:text-6xl">Vision and Mission</h1>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-white/75 sm:text-lg">
          The purpose, commitments, and goals that guide the Polytechnic University of the Philippines.
        </p>
      </ScrollReveal>
    </section>
  )
