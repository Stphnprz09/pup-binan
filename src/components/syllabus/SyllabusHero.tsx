...
export function SyllabusHero() {
  return (
    <section className="relative isolate grid min-h-[420px] place-items-center overflow-hidden px-5 py-20 text-center text-white lg:min-h-[500px]">
      ...
      <ScrollReveal>
        <p className="text-xs font-bold uppercase tracking-[0.28em] text-amber-300">Curriculum and instruction</p>
        <h1 className="mx-auto mt-5 max-w-6xl text-4xl font-black uppercase tracking-tight sm:text-5xl lg:text-6xl">Program Syllabi</h1>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-white/80 sm:text-lg">
          Access course syllabi outlining learning outcomes, subject content, assessment, and instructional requirements by program.
        </p>
      </ScrollReveal>
    </section>
  )
