...
export function ChedMemorandumHero() {
  return (
    <section className="relative isolate grid min-h-[420px] place-items-center overflow-hidden px-5 py-20 text-center text-white lg:min-h-[500px]">
      ...
      <ScrollReveal>
        <p className="text-xs font-bold uppercase tracking-[0.28em] text-amber-300">Program policies and standards</p>
        <h1 className="mx-auto mt-5 max-w-6xl text-4xl font-black uppercase tracking-tight sm:text-5xl lg:text-6xl">CHED Memorandum Order</h1>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-white/80 sm:text-lg">
          Access the applicable Commission on Higher Education memorandum orders for PUP Biñan academic programs.
        </p>
      </ScrollReveal>
    </section>
  )
