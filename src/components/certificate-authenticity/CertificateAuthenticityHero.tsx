...
export function CertificateAuthenticityHero() {
  return (
    <section className="relative isolate grid min-h-[420px] place-items-center overflow-hidden px-5 py-20 text-center text-white lg:min-h-[500px]">
      ...
      <ScrollReveal>
        <p className="text-xs font-bold uppercase tracking-[0.28em] text-amber-300">Quality assurance</p>
        <h1 className="mx-auto mt-5 max-w-5xl text-4xl font-black uppercase tracking-tight sm:text-5xl lg:text-6xl">Certificate of Authenticity</h1>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-white/80 sm:text-lg">
          Official verification of the authenticity and integrity of accreditation information and supporting documents.
        </p>
      </ScrollReveal>
    </section>
  )
